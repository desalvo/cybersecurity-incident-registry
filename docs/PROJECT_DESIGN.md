## Aggiornamento 0.4.0-33 - Struttura documentazione utente e amministrativa
...
## Aggiornamento 0.4.0-33 - Anteprima CC precompilata e svuotamento manuale
...
## Baseline progettuale 0.4.0-33 - build 20260523
...
## Aggiornamento 0.4.0-33 - Pulsanti data/ora locale e azioni notifica
...
## Aggiornamento 0.4.0-33 - Workflow con dipendenze da notifiche e percorso guidato
...
La baseline 0.4.0-33 stabilizza l'applicazione come registro operativo bilingue per incidenti informatici. Include:
...
La build 20260523 aggiunge il modulo `app/security.py`, inizializzato da `create_app()` prima della registrazione delle blueprint. Il modulo applica una baseline production-ready senza introdurre dipendenze esterne obbligatorie:
...
```text
Scrivi un'applicazione web completa chiamata “Cybersecurity Incident Registry”, versione 0.4.0-33, build 20260523, autore Alessandro De Salvo <Alessandro.DeSalvo@roma1.infn.it>, da usare come registro degli incidenti informatici.
...
## Aggiornamento 0.4.0-33 - Identità utente composta
...
### Aggiornamento 0.4.0-33 - Visualizzazione provider nel tipo login SSO
...
## Aggiornamento 0.4.0-33 - Placeholder notifiche manuali e link incidente esplicito
...
## Aggiornamento 0.4.0-33 - Picker rubrica destinatari esterni
...
## Aggiornamento 0.4.0-33 - Tag automatici dei documenti generati
...
Metadati runtime aggiornati: versione `0.4.0-33`, build `20260523`.

## Aggiornamento 0.4.0-33 - Gestione rubrica destinatari esterni per utenti writer
...
### Aggiornamento 0.4.0-33 - Workflow interattivo nella pagina incidente
...
## Aggiornamento 0.4.0-33 - Ricerca nella rubrica destinatari esterni
...
## Aggiornamento 0.4.0-33 - Modelli incidente e gestione utenti
...
## Aggiornamento 0.4.0-33 - Correzione sequence audit nelle operazioni utenti
...
## Aggiornamento 0.4.0-33 - Full import con ricostruzione dello schema database
...
### Correzione sequence utenti 0.4.0-33
...
## Aggiornamento 0.4.0-33 - Riallineamento sequence PostgreSQL generalizzato
...
## Aggiornamento 0.4.0-33 - Riferimento incidente obbligatorio
...
## Versione 0.4.0-33 - Workflow condizionali e provisioning utenti
...
## Versione 0.4.0-33 - Hardening sequence step workflow
...
## Versione 0.4.0-33 - Estensione workflow di default
...
## Aggiornamento 0.4.0-33 - Frecce negli step workflow e versione applicativa

La pagina del singolo incidente visualizza gli step delle operazioni previste con una freccia di sequenza quando il workflow è ordinato tramite il campo `position`. Il template `incident_detail.html` aggiunge l'indicatore tra due step consecutivi e `style.css` ne definisce il layout responsive. I metadati runtime dell'applicazione usano la versione normalizzata `0.4.0-33` e il build `20260523`, visibili in Info → Applicazione e configurabili tramite `APP_VERSION` e `APP_BUILD`.

## Aggiornamento 0.4.0-33 - Cancellazione incidenti con stati deadline collegati
...
### 0.4.0-33 - Blocco invio admin e autosalvataggio destinatari
...
## Versione 0.4.0-33 - Avvisi procedurali basati sul workflow richiesto
...
## Version 0.4.0-33 - Procedural warnings based on required workflow steps
...
## Versione 0.4.0-33 - Operazioni automatiche sulle label azione
...
## Version 0.4.0-33 - Automatic operations on action labels
...
## Versione 0.4.0-33 - Leggibilità label azioni
...
## Version 0.4.0-33 - Action-label readability
...
## Versione 0.4.0-33 - Controllo globale sui task
...
## Version 0.4.0-33 - Global task check
...
## Versione 0.4.0-33 - Condizioni workflow estese
...
## Version 0.4.0-33 - Extended workflow conditions
...
## Versione 0.4.0-33 - Pulizia versione e documentazione

La versione applicativa esposta da `APP_VERSION` e dalla pagina Info è normalizzata a `0.4.0-33`, con build `20260523`. Le guide utente e amministrativa sono mantenute come documentazione operativa dello stato corrente: non devono contenere banner di versione né blocchi di changelog. Le variazioni cronologiche sono centralizzate in `CHANGELOG.txt` e nelle pagine `release_notes.html` / `release_notes_en.html`.

## Version 0.4.0-33 - Version and documentation cleanup

The application version exposed by `APP_VERSION`, the Info page and the guides is normalized to `0.4.0-33`, with build `20260523`. User and administrator guides are maintained as operational documentation of the current state and must not contain changelog blocks. Chronological changes are centralized in `CHANGELOG.txt` and in `release_notes.html` / `release_notes_en.html`.

## Versione 0.4.0-33 - Riallineamento guide operative
...
## Version 0.4.0-33 - Operational guide alignment
...
## Aggiornamento 0.4.0-33 - Bonifica criticità progettuali
...
## Aggiornamento 0.4.0-33 - Scheduler notifiche seriale e anti-duplicazione mail
...
## Aggiornamento 0.4.0-33 - Stato notifiche schedulate e cambio password solo locale
...
## Aggiornamento 0.4.0-33 - Audit robusto nel controllo manuale e promemoria senza slot
...
## Aggiornamento 0.4.0-33 - Controllo manuale dei promemoria specifici e audit dettagliato
...
## Aggiornamento 0.4.0-33 - Risoluzione destinatari dei promemoria specifici
...
## Aggiornamento 0.4.0-33 - Diagnostica controllo manuale promemoria e destinatari deadline
...
## Aggiornamento 0.4.0-33 - Scheduler, URL e stato servizi
...
### Aggiornamento 0.4.0-33 - Contesto applicativo dei thread scheduler
...
## Aggiornamento 0.4.0-33 - Sezioni collassabili nel dettaglio incidente
...
## Aggiornamento 0.4.0-33 - Sezioni incidente e workflow guidato
...
## Aggiornamento 0.4.0-33 - Tag documenti nel dettaglio incidente
...
## Aggiornamento 0.4.0-33 - CC predefinito notifiche utente
...
### Aggiornamento 0.4.0-33 - Submit diretto dei destinatari manuali
...
## Aggiornamento 0.4.0-33 - Campi manuali acquisiti al submit notifiche
...
## Aggiornamento 0.4.0-33 - Precedenza CC manuale vuoto

Nelle notifiche manuali, quando il template consente la modifica del campo CC, il valore digitato manualmente resta prevalente; se il campo CC viene svuotato dall’operatore, tale valore vuoto annulla il default del template e la mail viene inviata senza CC. Dalla versione 0.4.0-33 l’anteprima precompila nuovamente il campo CC con il valore di default del template, quando presente, lasciando comunque al submit la priorità al valore manuale effettivo.

## Aggiornamento 0.4.0-33 - Abilitazione esplicita del CC in anteprima
...
## Aggiornamento 0.4.0-33 - Markdown e colori negli step workflow
...
## Aggiornamento 0.4.0-33 - Tag notifica configurabili sui template modulo
...
## Aggiornamento 0.4.0-33 - Rimozione tag dai template modulo
...
### 0.4.0-33 - Rischio per diritti e libertà e pending actions condizionate
...
### 0.4.0-33 - Risk to rights and freedoms and conditioned pending actions
...
## Hardening AGID 0.4.0-33

La versione 0.4.0-33 rafforza la conformità alle linee guida AGID per lo sviluppo sicuro:
