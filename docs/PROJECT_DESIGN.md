## Aggiornamento 0.3.0-1 - Anteprima CC precompilata e svuotamento manuale
...
## Baseline progettuale 0.3.0-1 - build 2026052101
...
## Aggiornamento 0.3.0-1 - Pulsanti data/ora locale e azioni notifica
...
## Aggiornamento 0.3.0-1 - Workflow con dipendenze da notifiche e percorso guidato
...
La baseline 0.3.0-1 stabilizza l'applicazione come registro operativo bilingue per incidenti informatici. Include:
...
La build 2026052101 aggiunge il modulo `app/security.py`, inizializzato da `create_app()` prima della registrazione delle blueprint. Il modulo applica una baseline production-ready senza introdurre dipendenze esterne obbligatorie:
...
```text
Scrivi un'applicazione web completa chiamata “Cybersecurity Incident Registry”, versione 0.3.0-1, build 2026052101, autore Alessandro De Salvo <Alessandro.DeSalvo@roma1.infn.it>, da usare come registro degli incidenti informatici.
...
## Aggiornamento 0.3.0-1 - Identità utente composta
...
### Aggiornamento 0.3.0-1 - Visualizzazione provider nel tipo login SSO
...
## Aggiornamento 0.3.0-1 - Placeholder notifiche manuali e link incidente esplicito
...
## Aggiornamento 0.3.0-1 - Picker rubrica destinatari esterni
...
## Aggiornamento 0.3.0-1 - Tag automatici dei documenti generati
...
Metadati runtime aggiornati: versione `0.3.0-1`, build `2026052101`.

## Aggiornamento 0.3.0-1 - Gestione rubrica destinatari esterni per utenti writer
...
### Aggiornamento 0.3.0-1 - Workflow interattivo nella pagina incidente
...
## Aggiornamento 0.3.0-1 - Ricerca nella rubrica destinatari esterni
...
## Aggiornamento 0.3.0-1 - Modelli incidente e gestione utenti
...
## Aggiornamento 0.3.0-1 - Correzione sequence audit nelle operazioni utenti
...
## Aggiornamento 0.3.0-1 - Full import con ricostruzione dello schema database
...
### Correzione sequence utenti 0.3.0-1
...
## Aggiornamento 0.3.0-1 - Riallineamento sequence PostgreSQL generalizzato
...
## Aggiornamento 0.3.0-1 - Riferimento incidente obbligatorio
...
## Versione 0.3.0-1 - Workflow condizionali e provisioning utenti
...
## Versione 0.3.0-1 - Hardening sequence step workflow
...
## Versione 0.3.0-1 - Estensione workflow di default
...
## Aggiornamento 0.3.0-1 - Frecce negli step workflow e versione applicativa

La pagina del singolo incidente visualizza gli step delle operazioni previste con una freccia di sequenza quando il workflow è ordinato tramite il campo `position`. Il template `incident_detail.html` aggiunge l'indicatore tra due step consecutivi e `style.css` ne definisce il layout responsive. I metadati runtime dell'applicazione usano la versione normalizzata `0.3.0-1` e il build `2026052101`, visibili in Info → Applicazione e configurabili tramite `APP_VERSION` e `APP_BUILD`.

## Aggiornamento 0.3.0-1 - Cancellazione incidenti con stati deadline collegati
...
### 0.3.0-1 - Blocco invio admin e autosalvataggio destinatari
...
## Versione 0.3.0-1 - Avvisi procedurali basati sul workflow richiesto
...
## Version 0.3.0-1 - Procedural warnings based on required workflow steps
...
## Versione 0.3.0-1 - Operazioni automatiche sulle label azione
...
## Version 0.3.0-1 - Automatic operations on action labels
...
## Versione 0.3.0-1 - Leggibilità label azioni
...
## Version 0.3.0-1 - Action-label readability
...
## Versione 0.3.0-1 - Controllo globale sui task
...
## Version 0.3.0-1 - Global task check
...
## Versione 0.3.0-1 - Condizioni workflow estese
...
## Version 0.3.0-1 - Extended workflow conditions
...
## Versione 0.3.0-1 - Pulizia versione e documentazione

La versione applicativa esposta da `APP_VERSION` e dalla pagina Info è normalizzata a `0.3.0-1`, con build `2026052101`. Le guide utente e amministrativa sono mantenute come documentazione operativa dello stato corrente: non devono contenere banner di versione né blocchi di changelog. Le variazioni cronologiche sono centralizzate in `CHANGELOG.txt` e nelle pagine `release_notes.html` / `release_notes_en.html`.

## Version 0.3.0-1 - Version and documentation cleanup

The application version exposed by `APP_VERSION`, the Info page and the guides is normalized to `0.3.0-1`, with build `2026052101`. User and administrator guides are maintained as operational documentation of the current state and must not contain changelog blocks. Chronological changes are centralized in `CHANGELOG.txt` and in `release_notes.html` / `release_notes_en.html`.

## Versione 0.3.0-1 - Riallineamento guide operative
...
## Version 0.3.0-1 - Operational guide alignment
...
## Aggiornamento 0.3.0-1 - Bonifica criticità progettuali
...
## Aggiornamento 0.3.0-1 - Scheduler notifiche seriale e anti-duplicazione mail
...
## Aggiornamento 0.3.0-1 - Stato notifiche schedulate e cambio password solo locale
...
## Aggiornamento 0.3.0-1 - Audit robusto nel controllo manuale e promemoria senza slot
...
## Aggiornamento 0.3.0-1 - Controllo manuale dei promemoria specifici e audit dettagliato
...
## Aggiornamento 0.3.0-1 - Risoluzione destinatari dei promemoria specifici
...
## Aggiornamento 0.3.0-1 - Diagnostica controllo manuale promemoria e destinatari deadline
...
## Aggiornamento 0.3.0-1 - Scheduler, URL e stato servizi
...
### Aggiornamento 0.3.0-1 - Contesto applicativo dei thread scheduler
...
## Aggiornamento 0.3.0-1 - Sezioni collassabili nel dettaglio incidente
...
## Aggiornamento 0.3.0-1 - Sezioni incidente e workflow guidato
...
## Aggiornamento 0.3.0-1 - Tag documenti nel dettaglio incidente
...
## Aggiornamento 0.3.0-1 - CC predefinito notifiche utente
...
### Aggiornamento 0.3.0-1 - Submit diretto dei destinatari manuali
...
## Aggiornamento 0.3.0-1 - Campi manuali acquisiti al submit notifiche
...
## Aggiornamento 0.3.0-1 - Precedenza CC manuale vuoto

Nelle notifiche manuali, quando il template consente la modifica del campo CC, il valore digitato manualmente resta prevalente; se il campo CC viene svuotato dall’operatore, tale valore vuoto annulla il default del template e la mail viene inviata senza CC. Dalla versione 0.3.0-1 l’anteprima precompila nuovamente il campo CC con il valore di default del template, quando presente, lasciando comunque al submit la priorità al valore manuale effettivo.

## Aggiornamento 0.3.0-1 - Abilitazione esplicita del CC in anteprima
...
## Aggiornamento 0.3.0-1 - Markdown e colori negli step workflow
...
## Aggiornamento 0.3.0-1 - Tag notifica configurabili sui template modulo
...
## Aggiornamento 0.3.0-1 - Rimozione tag dai template modulo
...
### 0.3.0-1 - Rischio per diritti e libertà e pending actions condizionate
...
### 0.3.0-1 - Risk to rights and freedoms and conditioned pending actions
