0.6.0-31 - Manual notification CC enable switch
...
0.6.0-31 - Prefilled CC preview and manual clearing
...
The operational documentation describes the current state of platform 0.6.0-31, build 20260530. Chronological changes are maintained in Release notes and in `CHANGELOG.txt`, not in the user or administrator guides.

## Secure development compliance - build 20260530

Build 0.6.0-31 adds application hardening aligned with the attached secure development guidelines:
...
## Production hardening build 20260530
...
## Update 0.6.0-31 - Notification scheduler, anti-flooding and time zone
...
### Update 0.6.0-317 - Incident templates and orphan document cleanup
...
### Update 0.6.0-31 - Serial notification scheduler
...
## Update 0.6.0-31 - Audit for incidents skipped by the notification scheduler
...
## Update 0.6.0-31 - Manual deadline check and one-off reminders
...
## Update 0.6.0-31 - Manual one-off reminder check
...
## Update 0.6.0-31 - One-off reminder check fix
...
### Update 0.6.0-31 - Specific reminders are not blocked by technical claims
...
### Update 0.6.0-31 - Reminder scheduler and service status page
...
Document notification tags can be associated or removed through the drag-and-drop palette in the incident detail Documents section; each document also provides a direct `Download` button. Selected tags are saved explicitly and used to preselect attachments in manual notifications. The `Save tags` button is also available in incident-button automatic actions: its row accepts notification tags by drag and drop and runs the automatic action only when at least one configured tag is present on the saved document.
...
### 0.6.0-31 - Risk to rights and freedoms and workflow-aware deadline notifications
...
## AGID compliance hardening - 0.6.0-31 build 20260530
...
## AGID compliance refinement - 0.6.0-31 build 20260530
