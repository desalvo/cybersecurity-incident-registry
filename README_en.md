0.4.0-33 - Manual notification CC enable switch
...
0.4.0-33 - Prefilled CC preview and manual clearing
...
The operational documentation describes the current state of platform 0.4.0-33, build 20260523. Chronological changes are maintained in Release notes and in `CHANGELOG.txt`, not in the user or administrator guides.

## Secure development compliance - build 20260523

Build 0.4.0-33 adds application hardening aligned with the attached secure development guidelines:
...
## Production hardening build 20260523
...
## Update 0.4.0-33 - Notification scheduler, anti-flooding and time zone
...
### Update 0.4.0-33 - Serial notification scheduler
...
## Update 0.4.0-33 - Audit for incidents skipped by the notification scheduler
...
## Update 0.4.0-33 - Manual deadline check and one-off reminders
...
## Update 0.4.0-33 - Manual one-off reminder check
...
## Update 0.4.0-33 - One-off reminder check fix
...
### Update 0.4.0-33 - Specific reminders are not blocked by technical claims
...
### Update 0.4.0-33 - Reminder scheduler and service status page
...
### 0.4.0-33 - Risk to rights and freedoms and workflow-aware deadline notifications
...
## AGID compliance hardening - 0.4.0-33 build 20260523
...
## AGID compliance refinement - 0.4.0-33 build 20260523
...
The standard AGID compliance suite keeps one evidence directory under `compliance/agid/<RUN_ID>/` and runs `pip check`, `compileall`, full pytest, AGID dynamic tests, Bandit and blocking `pip-audit`. The `pip-audit` step requires network access to the vulnerability-intelligence service and is enforced by the included CI workflow.
