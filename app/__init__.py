...
def bootstrap(app):
    ...
    try:
        ...
        ensure_notification_type('user','Notifica utente','Notifica generica a un destinatario specificato in fase di invio; usa CC Utente come valore predefinito del campo CC','manual','','user_cc')
