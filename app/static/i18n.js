(function(){
  ...
  const D = {
    ...
    'Admin':'Admin','Liste configurabili':'Configurable lists','Personale':'Personnel','Logo':'Logo','Utenti':'Users','Dati titolare':'Controller data','Struttura':'Structure','Dati responsabile':'Responsible person data','Raccomandazioni':'Recommendations','Altre configurazioni':'Other settings','Audit':'Audit','Configurazione generale':'General configuration','Anagrafiche e workflow':'Master data and workflow','Utenti e accesso':'Users and access','Controllo e audit':'Control and audit',
    ...
    'Accedi':'Sign in','Username':'Username','Password':'Password','Logout':'Logout','Password attuale':'Current password','Nuova password':'New password','Conferma nuova password':'Confirm new password','Promemoria specifici':'Specific reminders','Data e ora invio':'Send date and time','Email in CC':'CC emails','Messaggio':'Message','Aggiungi promemoria':'Add reminder','Programmato':'Scheduled','Inviato':'Sent','reinvia se già inviato':'resend if already sent','Nessun promemoria specifico configurato.':'No specific reminders configured.','Promemoria cancellato':'Reminder deleted','Promemoria aggiornato':'Reminder updated','Promemoria aggiunto':'Reminder added'
  };
